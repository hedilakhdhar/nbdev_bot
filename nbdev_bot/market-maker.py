# AUTOGENERATED! DO NOT EDIT! File to edit: 01_market-maker.ipynb (unless otherwise specified).

__all__ = ['AMOUNT_TO_TRADE', 'INSTRUMENT_NAME', 'CLIENT_ID', 'CLIENT_SECRET', 'deribit', 'logwritter', 'first_trade',
           'step_in_algo', 'First_setuper', 'Order_manager']
